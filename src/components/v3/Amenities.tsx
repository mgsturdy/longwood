...
export default function Amenities() {
  return (
    <section id="amenities" className="py-20 sm:py-28 bg-cream-v3" aria-labelledby="amenities-heading">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 id="amenities-heading" className="text-3xl sm:text-4xl lg:text-5xl font-bold text-forest tracking-tight">
              {AMENITIES.title}
            </h2>
            <p className="mt-4 text-lg text-warm-brown/80 leading-relaxed">
              {AMENITIES.description}
            </p>

            <div className="mt-8 rounded-2xl bg-soft-white border-2 border-dashed border-sage/30 p-8">
