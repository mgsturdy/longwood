    ...
    <section id="gallery" className="py-20 lg:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <p className="text-xl text-warm-gray">{GALLERY.subtitle}</p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filtered.map((img) => (
            <button
              ...
              className="relative aspect-[4/3] rounded-lg overflow-hidden group cursor-pointer focus:outline-none focus-visible:ring-4 focus-visible:ring-gold"
            >
              <Image
                src={img.src}
                alt={img.alt}
        ...
        <div className="mt-12 grid sm:grid-cols-2 gap-6">
          <div className="bg-cream rounded-lg p-8 text-center">
            <svg className="w-12 h-12 text-warm-gray mx-auto mb-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
