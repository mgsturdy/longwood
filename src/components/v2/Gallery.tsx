...
export default function Gallery() {
  ...
  return (
    <section ref={sectionRef} id="gallery" className="bg-ivory py-24 lg:py-32">
        ...
        >
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-5 py-2 text-xs font-medium tracking-widest uppercase transition-all duration-300 ${
                activeFilter === cat
                  ? 'bg-copper text-black-deep'
                  : 'border border-neutral-200 text-neutral-600 hover:border-copper/40 hover:text-copper'
              }`}
            >
        ...
        >
          {filtered.map((image, i) => (
            <button
              ...
              className="group mb-4 block w-full overflow-hidden break-inside-avoid focus:outline-none focus-visible:ring-2 focus-visible:ring-copper"
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-black-deep/0 transition-colors duration-300 group-hover:bg-black-deep/20" />
                <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  <span className="flex h-12 w-12 items-center justify-center bg-copper/90 text-black-deep">
      ...
      {lightbox !== null && (
        ...
        >
          ...
          <button
            ...
            className="absolute left-4 top-1/2 z-10 -translate-y-1/2 p-2 text-ivory/50 transition-colors hover:text-ivory"
          ...
          <button
            onClick={(e) => { e.stopPropagation(); navigateLightbox(1); }}
            className="absolute right-4 top-1/2 z-10 -translate-y-1/2 p-2 text-ivory/50 transition-colors hover:text-ivory"
